...
public class CustomersDaoImpl implements CustomersDao {
    ...
    public boolean isCustomerExists(String email, String password) throws SQLException {
        ...
        PreparedStatement statement = con.prepareStatement("select email,password from customers");
    ...
    private List<Coupon> getAllCouponsById(int customerId) throws SQLException {
        Connection con = pool.getConnection();
