...
public class CouponsDaoImpl implements CouponsDao {
    ...
    @Override
    public void addCouponPurchase(int customerId, int couponId) throws SQLException, MyException {
        Connection con = pool.getConnection();
        try {
    ...
    public boolean isPurchaseExist(int customerId, int couponId) throws MyException {
        Connection con = pool.getConnection();
        try {
